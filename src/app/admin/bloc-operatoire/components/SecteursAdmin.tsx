...
import { PlusCircle, PencilLine, Trash2, AlertCircle, Palette, Layers } from 'lucide-react';
          ...
          <div className="grid gap-4 py-4">
                  ...
                  {COLOR_PRESETS.map(color => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border ${
                        currentSecteur?.couleur === color ? 'ring-2 ring-offset-2 ring-primary' : ''
                      }`}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button type="button" variant="secondary" onClick={handleAddSpecialite}>
              ...
              {currentSecteur?.specialites && currentSecteur.specialites.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground mt-2">Aucune spécialité ajoutée</p>
              )}
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="estActif">Secteur actif et disponible pour la planification</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="requiresSpecificSkills">Requiert des compétences spécifiques</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="supervisionSpeciale">Nécessite une supervision particulière</Label>
              </div>
            </div>
          </div>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Êtes-vous sûr de vouloir supprimer le secteur {currentSecteur?.nom} ? Cette action est
              irréversible.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 my-4">
            <p className="text-yellow-800 text-sm">
              ...
              Vous ne pouvez pas supprimer un secteur contenant des salles. Veuillez d'abord
              réaffecter toutes les salles de ce secteur.
            </p>
          </div>
