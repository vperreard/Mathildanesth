...
const FormSchema = z.object({
  ...
  couleur: z
    .string()
    .regex(/^#[0-9a-fA-F]{6}$/, { message: 'Format de couleur invalide (#RRGGBB).' }),
  estActif: z.boolean(),
});
        ...
        <form onSubmit={handleFormSubmit} className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {form.formState.errors.nom && (
              <p className="col-span-4 text-red-500 text-sm text-right -mt-2">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              className={cn(
                'col-span-1 h-10 w-16 p-1 border-none',
                form.formState.errors.couleur && 'border-red-500 ring-2 ring-red-500'
              )}
              disabled={isLoading}
            />
            <span className="col-span-2 text-sm text-gray-500 dark:text-gray-400">
              {form.watch('couleur')}
            </span>
            ...
            <div className="col-span-3 flex items-center">
              <Switch
                ...
                onCheckedChange={(checked: boolean) =>
                  form.setValue('estActif', checked, { shouldValidate: true })
                }
                disabled={isLoading}
              />
            </div>
