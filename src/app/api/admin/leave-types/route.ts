...
export async function GET(request: Request) {
    try {
        ...
        logger.error('Erreur API [GET /admin/leave-types]:', { error: error });
...
export async function POST(request: Request) {
    try {
        ...
        logger.error('Erreur API [POST /admin/leave-types]:', { error: error });
...
export async function PUT(request: Request) {
    try {
        ...
        logger.error('Erreur API [PUT /admin/leave-types]:', { error: error });
...
export async function DELETE(request: Request) {
    try {
        ...
        logger.error('Erreur API [DELETE /admin/leave-types]:', { error: error });
