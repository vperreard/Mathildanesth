...
export async function GET(request: NextRequest, { params }: SkillRouteParams) {
    try {
        const { skillId } = skillIdSchema.parse(params);
...
export async function PUT(request: NextRequest, { params }: SkillRouteParams) {
    try {
...
export async function DELETE(request: NextRequest, { params }: SkillRouteParams) {
    try {
        const currentUser = await getCurrentUser();
