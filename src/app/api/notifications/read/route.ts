...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        if (!body.id && !body.relatedRequestId && (!body.types || body.types.length === 0) && !body.all) {
        ...
        console.log(`POST /api/notifications/read: ${result.count} notification(s) marquée(s) comme lue(s)`);
        ...
        console.log(`POST /api/notifications/read: Il reste ${unreadCount} notification(s) non lue(s) pour l'utilisateur`);
