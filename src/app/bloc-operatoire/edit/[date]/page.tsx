...
import { BlocDayPlanning, OperatingRoom, BlocSector, SupervisionRule, BlocRoomAssignment } from '@/types/bloc-planning-types';
...
export default function EditBlocPlanningPage() {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const [planningData, sallesData, secteursData, rulesData] = await Promise.all([
                    blocPlanningService.getDayPlanning(formattedDate),
    ...
    const handleSavePlanning = async (updatedPlanning: BlocDayPlanning) => {
        ...
        try {
            ...
            setSuccessMessage("Planning enregistré avec succès");
            ...
            setError("Erreur lors de la sauvegarde du planning. Veuillez réessayer.");
        } finally {
            setSaving(false);
        }
    };
        ...
        <div className="container mx-auto py-6 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h1 className="text-3xl font-bold mt-2">Édition du Planning</h1>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center">
                        ...
                        Planning du {formattedDateDisplay}
                    </CardTitle>
                    <CardDescription>
                        Définissez les affectations des salles et des superviseurs pour cette journée
                    </CardDescription>
                </CardHeader>
