    ...
    return (
        ...
        >
            ...
            {removable && onRemove && (
                <button
                    type="button"
                    className="ml-1 -mr-1 h-3.5 w-3.5 rounded-full inline-flex items-center justify-center text-current hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-current focus:ring-offset-2"
                    onClick={(e) => {
                        e.stopPropagation();
                        onRemove();
                    }}
                    aria-label={`Supprimer ${ariaLabel || 'le badge'}`}
                >
