...
describe('UserForm', () => {
  ...
  describe('Form Submission', () => {
    ...
    it('should include selected skills in submission', async () => {
      ...
      // Select skills
      await user.click(screen.getByTestId('checkbox-skill-1'));
  ...
  describe('Form Cancellation', () => {
    ...
    it('should show confirmation when canceling with unsaved changes', async () => {
      ...
      // Make some changes
      await user.type(screen.getByLabelText(/nom/i), 'Changed');
  ...
  describe('Accessibility', () => {
    ...
    it('should have proper error announcements for screen readers', async () => {
      ...
      await waitFor(() => {
        const errorMessage = screen.getByText(/le nom est requis/i);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long input values', async () => {
      ...
      expect(nameField.value.length).toBeLessThanOrEqual(50);
    });
  });
});
