...
jest.mock('date-fns', () => ({
    ...
    differenceInDays: jest.fn((date1: Date, date2: Date) => {
        ...
        return Math.floor((utc1 - utc2) / msPerDay) + 1; // +1 for inclusive counting
    }),
...
describe('useDateValidation - Fixed Tests', () => {
    ...
    describe('Utility Functions', () => {
        ...
        describe('calculateDurationInDays', () => {
            it('calculates duration correctly', () => {
                ...
                // Mock differenceInDays to return expected value
                const mockDifferenceInDays = require('date-fns').differenceInDays;
                mockDifferenceInDays.mockReturnValueOnce(6);
            ...
            it('returns 1 for same day', () => {
                ...
                // Mock differenceInDays to return 1 for same day
                const mockDifferenceInDays = require('date-fns').differenceInDays;
    ...
    describe('Hook useDateValidation', () => {
        ...
        it('manages field errors', () => {
            ...
            act(() => {
                result.current.validateDate(new Date('invalid'), 'testDate');
            });
            ...
            act(() => {
                result.current.clearFieldError('testDate');
            });
        ...
        it('clears all errors', () => {
            ...
            act(() => {
                result.current.validateDate(new Date('invalid'), 'field1');
                result.current.validateDate(new Date('invalid'), 'field2');
            });
