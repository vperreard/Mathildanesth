...
jest.mock('../../../ui/components', () => ({
    ...
    ListGroup: ({ children, ...props }: any) => (
        <ul data-testid="list-group" {...props}>{children}</ul>
    ),
    ListGroupItem: ({ children, ...props }: any) => (
        <li data-testid="list-group-item" {...props}>{children}</li>
    ),
    Progress: ({ value, max, color, ...props }: any) => (
        <div data-testid="progress" data-value={value} data-max={max} data-color={color} {...props} />
    ),
    Tag: ({ children, color, size, ...props }: any) => (
        <span data-testid="tag" data-color={color} data-size={size} {...props}>{children}</span>
    )
}));
