...
export class QuotaManagementService {
    ...
    public async getTransferRules(sourceType: LeaveType): Promise<QuotaTransferRule[]> {
        try {
            const response = await fetch(`http://localhost:3000/api/conges/quota-transfers/rules/${sourceType}`);
    ...
    public async getCarryOverRules(leaveType: LeaveType): Promise<QuotaCarryOverRule[]> {
        try {
            const response = await fetch(`http://localhost:3000/api/conges/quota-carryovers/rules/${leaveType}`);
    ...
    public async getActivePeriods(): Promise<QuotaPeriod[]> {
        try {
            const response = await fetch('http://localhost:3000/api/conges/quota-periods?active=true');
    ...
    public async getUserQuotaSummary(userId: string, periodId?: string): Promise<UserQuotaSummary | null> {
        try {
            ...
            const response = await fetch(`http://localhost:3000/api/conges/quotas/summary?userId=${userId}${periodParam}`);
    ...
    public async simulateTransfer(
        ...
        try {
            const response = await fetch('http://localhost:3000/api/conges/quota-transfers/simulate', {
                method: 'POST',
                headers: {
    ...
    public async requestTransfer(
        ...
        try {
            const response = await fetch('http://localhost:3000/api/conges/quota-transfers/request', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    public async processTransferRequest(
        ...
        try {
            const response = await fetch(`http://localhost:3000/api/conges/quota-transfers/${transferRequestId}/process`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    public async simulateCarryOver(
        ...
        try {
            const response = await fetch('http://localhost:3000/api/conges/quota-carryovers/simulate', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    public async requestCarryOver(
        ...
        try {
            const response = await fetch('http://localhost:3000/api/conges/quota-carryovers/request', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    public async processCarryOverRequest(
        ...
        try {
            const response = await fetch(`http://localhost:3000/api/conges/quota-carryovers/${carryOverRequestId}/process`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    public async calculateQuotaAvailability(
        ...
        try {
            const response = await fetch('http://localhost:3000/api/conges/quotas/calculate', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    public async adjustQuotaBalance(
        ...
        try {
            const response = await fetch('http://localhost:3000/api/conges/quotas/adjust', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
     ...
     */
    public subscribe(event: QuotaManagementEvents, callback: (data: unknown) => void): () => void {
