...
describe('ConflictDetectionService', () => {
  ...
  beforeEach(() => {
    ...
    // Mock configService properly without @ts-ignore
    ...
    Object.defineProperty(conflictDetectionService, 'configService', {
  ...
  it('setRules should call configService.setConfigValue', async () => {
    ...
    // Access configService through Object.getOwnPropertyDescriptor
    const configService = Object.getOwnPropertyDescriptor(
      conflictDetectionService,
      'configService'
    )?.value;
    expect(configService.setConfigValue).toHaveBeenCalledWith(
      'leaveConflictRules',
