...
export const useLeave = ({
    ...
    const checkAllowance = useCallback(async (): Promise<LeaveAllowanceCheckResult> => {
        ...
        try {
            ...
            logger.error('Erreur dans checkAllowance:', { error: err });
    ...
    const saveLeaveAsDraft = useCallback(async (): Promise<Leave> => {
        ...
        try {
            ...
            logger.error('Erreur dans saveLeaveAsDraft:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
    ...
    const submitLeave = useCallback(async (): Promise<Leave> => {
        ...
        try {
            ...
            logger.error('Erreur dans submitLeave:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
    ...
    const approveLeaveRequest = useCallback(async (comment?: string): Promise<Leave> => {
        ...
        try {
            ...
            logger.error('Erreur dans approveLeaveRequest:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
    ...
    const rejectLeaveRequest = useCallback(async (comment?: string): Promise<Leave> => {
        ...
        try {
            ...
            logger.error('Erreur dans rejectLeaveRequest:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
    ...
    const cancelLeaveRequest = useCallback(async (comment?: string): Promise<Leave> => {
        ...
        try {
            ...
            logger.error('Erreur dans cancelLeaveRequest:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
    ...
    const fetchUserLeaves = useCallback(async (filters: LeaveFilters = {}): Promise<void> => {
        ...
        try {
            ...
            logger.error('Erreur dans fetchUserLeaves:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
    ...
    const fetchLeaveDetails = useCallback(async (leaveId: string): Promise<void> => {
        ...
        try {
            ...
            logger.error('Erreur dans fetchLeaveDetails:', { error: err });
            // Convertir l'erreur au format ErrorDetails
            setLocalError({
                message: err.message,
                severity: 'error',
