...
export function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, leave, updatedLeave, error_1;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    id = params.id;
                    console.log("[API DELETE /api/leaves/".concat(id, "] Requ\u00EAte d'annulation re\u00E7ue"));
                    if (!id) {
                ...
                case 2:
                    ...
                    if (leave.status !== LeaveStatus.PENDING && leave.status !== LeaveStatus.APPROVED) {
                        return [2 /*return*/, NextResponse.json({ error: 'Seules les demandes en attente ou approuvées peuvent être annulées' }, { status: 400 })];
                    }
                ...
                case 4:
                    error_1 = _c.sent();
                    console.error("[API DELETE /api/leaves/".concat(id, "] Erreur lors de l'annulation:"), error_1);
                    return [2 /*return*/, NextResponse.json({ error: 'Erreur serveur lors de l\'annulation de la demande de congé' }, { status: 500 })];
