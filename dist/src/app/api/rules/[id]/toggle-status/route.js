...
export function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var ruleId, data, existingRule, updatedRule, serializedRule, error_1;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (data.isActive === undefined) {
                        return [2 /*return*/, NextResponse.json({ error: 'Le statut (isActive) doit être fourni' }, { status: 400 })];
                    }
                ...
                case 4:
                    error_1 = _c.sent();
                    console.error("Erreur lors du changement de statut de la r\u00E8gle ".concat(params.id, ":"), error_1);
                    return [2 /*return*/, NextResponse.json({ error: 'Erreur serveur lors du changement de statut de la règle' }, { status: 500 })];
