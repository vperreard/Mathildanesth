 ...
 */
export function filterRequestsForCalendar(requests, types, userId) {
 ...
 */
export function filterRequestsForAdmin(requests, options) {
    var types = options.types, status = options.status, userId = options.userId, _a = options.includeRefused, includeRefused = _a === void 0 ? false : _a, searchQuery = options.searchQuery;
    return requests.filter(function (request) {
 ...
 */
export function formatRequestForCalendar(request) {
