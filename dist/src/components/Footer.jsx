...
export default function Footer() {
    ...
    return (<footer className="bg-gray-50 border-t border-gray-100 pt-12 pb-8 mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pt-8 mt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        <motion.a href="#" className="text-gray-400 hover:text-primary-600 transition-colors" whileHover={{ scale: 1.1 }}>
