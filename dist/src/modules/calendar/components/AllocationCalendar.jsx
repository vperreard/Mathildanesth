...
export var AllocationCalendar = function (_a) {
    var onEventClick = _a.onEventClick;
    ...
    var handleEventClick = useCallback(function (eventId, eventType) {
        ...
        if (event) {
            ...
            var eventData = __assign(__assign(__assign({}, event), { id: realId, userId: event.userId }), event);
    ...
    return (<div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2 justify-end">
                        ...
                        <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                            ...
                            <button onClick={function () { return handleViewChange(CalendarViewType.TIMELINE); }} className={"px-3 py-2 text-sm border-l border-gray-300 ".concat(view === CalendarViewType.TIMELINE ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100')}>
                                Timeline
                            </button>
                        </div>
            ...
            {/* Filtres */}
            <CalendarFiltersComponent filters={filters} onFilterChange={updateFilters} availableEventTypes={[CalendarEventType.ASSIGNMENT, CalendarEventType.LEAVE]} showLeaveFilter={false} showUserFilter={true} showLocationFilter={true} showTeamFilter={true} showSpecialtyFilter={true}/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div>
                    <CalendarLegend showEventTypes={true} showLocations={true} showTeams={true} showSpecialties={true} selectedEventTypes={filters.eventTypes}/>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[80vh] overflow-y-auto">
                        ...
                        <div className="p-4">
                            <div className="space-y-3">
                                ...
                                {selectedEvent['locationName'] && (<div>
