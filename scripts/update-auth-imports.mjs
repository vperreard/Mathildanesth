 ...
 * 
 * Version compatible avec les modules ES
 */
...
// Obtenir le chemin du répertoire courant en modules ES
...
function shouldIgnorePath(filePath) {
    const ignorePaths = [
        ...
        'scripts/update-auth-imports.cjs',
        'scripts/update-auth-imports.mjs',
