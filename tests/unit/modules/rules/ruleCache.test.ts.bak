...
describe('RuleCacheService', () => {
    ...
    describe('Expiration des entrées du cache', () => {
        it('devrait expirer les entrées après leur TTL', () => {
            // Mettre en cache l'évaluation avec un TTL court (100ms)
            ...
            jest.spyOn(Date, 'now').mockImplementation(() => 1200); // 1000 + 200 > 1000 + 100
