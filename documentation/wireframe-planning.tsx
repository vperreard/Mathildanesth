...
import { Calendar, ChevronLeft, ChevronRight, Plus, Users, Bell, Settings, Filter, Download, AlertTriangle, Check, RefreshCw } from 'lucide-react';

const PlanningInterface = () => {
  const [currentWeek, setCurrentWeek] = useState('Semaine du 21 au 27 Avril 2025');
